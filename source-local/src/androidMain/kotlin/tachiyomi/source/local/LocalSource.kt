...
import yokaicore.core.metadata.comicinfo.COMIC_INFO_FILE
import yokaicore.core.metadata.comicinfo.ComicInfo
import yokaicore.core.metadata.comicinfo.copyFromComicInfo
import yokaicore.core.metadata.comicinfo.getComicInfo
import yokaicore.core.metadata.yokaicore.MangaDetails
...
import yokaicore.domain.chapter.service.ChapterRecognition
import yokaicore.domain.manga.model.Manga
import yokaicore.i18n.MR
import yokaicore.source.local.filter.OrderBy
import yokaicore.source.local.image.LocalCoverManager
import yokaicore.source.local.io.Archive
import yokaicore.source.local.io.Format
import yokaicore.source.local.io.LocalSourceFileSystem
import yokaicore.source.local.metadata.fillMetadata
...
actual class LocalSource(
    ...
    companion object {
        const val ID = 0L
        const val HELP_URL = "https://yokaicore.org/docs/guides/local-source/"
