package yokaicore.core.metadata.comicinfo
...
fun SManga.getComicInfo() = ComicInfo(
    ...
    publishingStatus = ComicInfo.PublishingStatusYokaiCore(
...
data class ComicInfo(
    ...
    val tags: Tags?,
    val web: Web?,
    val publishingStatus: PublishingStatusYokaiCore?,
    val categories: CategoriesYokaiCore?,
) {
    @XmlElement(false)
    ...
    @Serializable
    @XmlSerialName("PublishingStatusYokaiCore", "http://www.w3.org/2001/XMLSchema", "ty")
    data class PublishingStatusYokaiCore(@XmlValue(true) val value: String = "")

    @Serializable
    @XmlSerialName("Categories", "http://www.w3.org/2001/XMLSchema", "ty")
    data class CategoriesYokaiCore(@XmlValue(true) val value: String = "")
}
