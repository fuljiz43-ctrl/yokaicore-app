package yokaicore.domain.release.interactor
...
class GetApplicationRelease(
    ...
    private fun isNewVersion(
        ...
        return if (isPreview) {
            // Preview builds: based on releases in "fuljiz43-ctrl/yokaicore-app-preview" repo
            // tagged as something like "r1234"
            newVersion.toInt() > commitCount
        } else {
            // Release builds: based on releases in "fuljiz43-ctrl/yokaicore-app" repo
