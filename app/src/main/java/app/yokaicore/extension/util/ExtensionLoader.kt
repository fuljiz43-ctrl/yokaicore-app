...
import app.yokaicore.extension.model.LoadResult
import app.yokaicore.source.CatalogueSource
import app.yokaicore.source.Source
import app.yokaicore.source.SourceFactory
import app.yokaicore.util.lang.Hash
import app.yokaicore.util.storage.copyAndSetReadOnlyTo
 ...
 * installer, so other variants of YokaiCore and its forks can also use this extension.
 *
...
internal object ExtensionLoader {
    ...
    private const val EXTENSION_FEATURE = "yokaicore.extension"
    private const val METADATA_SOURCE_CLASS = "yokaicore.extension.class"
    private const val METADATA_SOURCE_FACTORY = "yokaicore.extension.factory"
    private const val METADATA_NSFW = "yokaicore.extension.nsfw"
    ...
    private fun loadExtension(context: Context, extensionInfo: ExtensionInfo): LoadResult {
        ...
        val extName = pkgManager.getApplicationLabel(appInfo).toString().substringAfter("YokaiCore: ")
