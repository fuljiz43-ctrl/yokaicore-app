...
import app.yokaicore.widget.YokaiCoreTextInputEditText.Companion.setIncognito
 ...
 * @see setIncognito
 */
class YokaiCoreTextInputEditText @JvmOverloads constructor(
    context: Context,
