package app.yokaicore.data.backup.restore

import android.content.Context
import android.net.Uri
import app.yokaicore.data.backup.BackupDecoder
import app.yokaicore.data.backup.BackupNotifier
import app.yokaicore.data.backup.models.BackupCategory
import app.yokaicore.data.backup.models.BackupManga
import app.yokaicore.data.backup.models.BackupPreference
import app.yokaicore.data.backup.models.BackupSourcePreferences
import app.yokaicore.data.backup.restore.restorers.CategoriesRestorer
import app.yokaicore.data.backup.restore.restorers.MangaRestorer
import app.yokaicore.data.backup.restore.restorers.PreferenceRestorer
    ...
    private fun writeErrorLog(): File {
        try {
            if (errors.isNotEmpty()) {
                val file = context.createFileInCacheDir("yokaicore_restore.txt")
