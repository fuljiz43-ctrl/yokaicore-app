...
import app.yokaicore.data.track.anilist.AnilistApi
import app.yokaicore.data.track.bangumi.BangumiApi
import app.yokaicore.data.track.myanimelist.MyAnimeListApi
import app.yokaicore.data.track.shikimori.ShikimoriApi
...
object SettingsTrackingScreen : SearchableSettings {
    ...
    override fun RowScope.AppBarAction() {
        ...
        IconButton(onClick = { uriHandler.openUri("https://yokaicore.org/docs/guides/tracking") }) {
            Icon(
