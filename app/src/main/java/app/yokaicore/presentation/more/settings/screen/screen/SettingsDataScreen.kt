...
import app.yokaicore.presentation.more.settings.screen.data.CreateBackupScreen
import app.yokaicore.presentation.more.settings.screen.data.RestoreBackupScreen
import app.yokaicore.presentation.more.settings.screen.data.StorageInfo
import app.yokaicore.presentation.more.settings.widget.BasePreferenceWidget
import app.yokaicore.presentation.more.settings.widget.PrefsHorizontalPadding
import app.yokaicore.presentation.util.relativeTimeSpanString
import app.yokaicore.data.backup.create.BackupCreateJob
import app.yokaicore.data.backup.restore.BackupRestoreJob
...
import yokaicore.core.storage.displayablePath
...
object SettingsDataScreen : SearchableSettings {
    ...
    const val HELP_URL = "https://yokaicore.org/docs/faq/storage"
    ...
    fun storageLocationPicker(
        storageDirPref: yokaicore.core.preference.Preference<String>,
