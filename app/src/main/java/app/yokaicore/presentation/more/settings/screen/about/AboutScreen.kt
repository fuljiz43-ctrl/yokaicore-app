...
import app.yokaicore.presentation.more.LogoHeader
...
import app.yokaicore.data.updater.AppUpdateChecker
import app.yokaicore.util.CrashLogUtil
import app.yokaicore.util.lang.toDateTimestampString
...
import yokaicore.presentation.core.components.LinkIcon
...
import yokaicore.presentation.core.icons.CustomIcons
import yokaicore.presentation.core.icons.Facebook
import yokaicore.presentation.core.icons.Github
import yokaicore.presentation.core.icons.Reddit
import yokaicore.presentation.core.icons.X
            ...
            ScrollbarLazyColumn(
                ...
                item {
                    TextPreferenceWidget(
                        ...
                        onPreferenceClick = { uriHandler.openUri("https://yokaicore.org/privacy/") },
                    )
                }
                ...
                item {
                    Row(
                        ...
                        LinkIcon(
                            ...
                            url = "https://yokaicore.org",
                        )
                        LinkIcon(
                            label = "X",
                            icon = CustomIcons.X,
                            url = "https://x.com/yokaicoreorg",
                        )
                        LinkIcon(
                            label = "Facebook",
                            icon = CustomIcons.Facebook,
                            url = "https://facebook.com/yokaicoreorg",
                        )
                        LinkIcon(
                            label = "Reddit",
                            icon = CustomIcons.Reddit,
                            url = "https://www.reddit.com/r/YokaiCore",
                        )
                        LinkIcon(
                            label = "GitHub",
                            icon = CustomIcons.Github,
                            url = "https://github.com/yokaicoreorg",
                        )
                    }
                }
            }
