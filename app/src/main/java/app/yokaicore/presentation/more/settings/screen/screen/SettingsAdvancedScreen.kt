...
import app.yokaicore.presentation.more.settings.screen.advanced.ClearDatabaseScreen
import app.yokaicore.presentation.more.settings.screen.debug.DebugInfoScreen
import app.yokaicore.data.download.DownloadCache
import app.yokaicore.data.library.MetadataUpdateJob
import app.yokaicore.network.NetworkHelper
import app.yokaicore.network.NetworkPreferences
import app.yokaicore.network.PREF_DOH_360
import app.yokaicore.network.PREF_DOH_ADGUARD
import app.yokaicore.network.PREF_DOH_ALIDNS
import app.yokaicore.network.PREF_DOH_CLOUDFLARE
import app.yokaicore.network.PREF_DOH_CONTROLD
import app.yokaicore.network.PREF_DOH_DNSPOD
import app.yokaicore.network.PREF_DOH_GOOGLE
import app.yokaicore.network.PREF_DOH_MULLVAD
import app.yokaicore.network.PREF_DOH_NJALLA
import app.yokaicore.network.PREF_DOH_QUAD101
import app.yokaicore.network.PREF_DOH_QUAD9
import app.yokaicore.network.PREF_DOH_SHECAN
import app.yokaicore.ui.more.OnboardingScreen
import app.yokaicore.util.CrashLogUtil
import app.yokaicore.util.system.isDevFlavor
import app.yokaicore.util.system.isPreviewBuildType
import app.yokaicore.util.system.isShizukuInstalled
import app.yokaicore.util.system.powerManager
import app.yokaicore.util.system.setDefaultSettings
