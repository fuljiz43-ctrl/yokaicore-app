package app.yokaicore.presentation.category.components
...
import androidx.compose.ui.focus.focusRequester
import app.yokaicore.core.preference.asToggleableState
...
fun ChangeCategoryDialog(
    ...
    if (initialSelection.isEmpty()) {
        AlertDialog(
            onDismissRequest = onDismissRequest,
            confirmButton = {
                yokaicore.presentation.core.components.material.TextButton(
                    onClick = {
                        onDismissRequest()
                        onEditCategories()
                    },
    ...
    AlertDialog(
        ...
        confirmButton = {
            Row {
                yokaicore.presentation.core.components.material.TextButton(onClick = {
                    onDismissRequest()
                    onEditCategories()
                }) {
                ...
                yokaicore.presentation.core.components.material.TextButton(onClick = onDismissRequest) {
                    Text(text = stringResource(MR.strings.action_cancel))
                }
                yokaicore.presentation.core.components.material.TextButton(
                    onClick = {
