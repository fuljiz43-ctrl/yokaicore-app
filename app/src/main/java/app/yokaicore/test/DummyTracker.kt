...
data class DummyTracker(
    ...
    override suspend fun update(
        track: app.yokaicore.data.database.models.Track,
        didReadChapter: Boolean,
    ): app.yokaicore.data.database.models.Track = track
    ...
    override suspend fun register(
        item: app.yokaicore.data.database.models.Track,
        mangaId: Long,
    ) = Unit
