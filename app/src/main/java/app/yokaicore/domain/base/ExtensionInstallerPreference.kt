package app.yokaicore.domain.base

import android.content.Context
import app.yokaicore.domain.base.BasePreferences.ExtensionInstaller
import app.yokaicore.util.system.hasMiuiPackageInstaller
