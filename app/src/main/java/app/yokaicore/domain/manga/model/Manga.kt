package app.yokaicore.domain.manga.model
...
import yokaicore.core.metadata.comicinfo.ComicInfoPublishingStatus
...
fun getComicInfo(manga: Manga, chapter: Chapter, chapterUrl: String, categories: List<String>?) = ComicInfo(
    ...
    categories = categories?.let { ComicInfo.CategoriesYokaiCore(it.joinToString()) },
    inker = null,
    colorist = null,
    letterer = null,
    coverArtist = null,
