package app.yokaicore.domain.track.model

import yokaicore.domain.track.model.Track
import app.yokaicore.data.database.models.Track as DbTrack
...
fun DbTrack.toDomainTrack(idRequired: Boolean = true): Track? {
    ...
    return Track(
        ...
        // See https://github.com/fuljiz43-ctrl/yokaicore-app/issues/10343
